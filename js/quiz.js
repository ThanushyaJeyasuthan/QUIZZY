...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function finishQuiz() {
        ...
        // Save score to local AppState for immediate use
        ...
        .then(data => {
            ...
            // ONLY redirect after the database confirms success
            window.location.href = `result_feedback.php?score=${score}&total=${totalQuestions}&category=${categoryQuery}`;
        })
        .catch(error => {
